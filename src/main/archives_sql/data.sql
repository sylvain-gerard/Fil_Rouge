...
INSERT INTO `fil_rouge`.`arme` (`marque`, `modele`, `type`, `calibre`, `numero_serie`, `infos_complementaire`) VALUES ('FN', 'FAMAS', 'Fusil d\'assaut', '5.56', '8K345876M13', '');
INSERT INTO `fil_rouge`.`arme` (`marque`, `modele`, `type`, `calibre`, `numero_serie`, `infos_complementaire`) VALUES ('Colt', 'Python', 'Revolver', '357 Magnum', '65433HY8', '');
INSERT INTO `fil_rouge`.`arme` (`marque`, `modele`, `type`, `calibre`, `numero_serie`, `infos_complementaire`) VALUES ('Berretta', '92S', 'Pistolet', '9mm', '1235TYU678', '');
...
INSERT INTO `fil_rouge`.`vehicule` (`infos_complementaire`, `marque`, `modele`, `type`, `couleur_vehicule`, `immatriculation`) VALUES ('Voiture la Poste', 'Renault', 'Kangoo', 'Utilitaire', 'Jaune', 'AB345RT');
INSERT INTO `fil_rouge`.`vehicule` (`infos_complementaire`, `marque`, `modele`, `type`, `couleur_vehicule`, `immatriculation`) VALUES ('', 'Scania', 'Serie G', 'Camion', 'Blanc', 'ER654YU');
...
INSERT INTO `fil_rouge`.`affaire` (`classee`, `date_cloture`, `date_creation`, `nom_affaire`, `pieces_conviction`) VALUES (False, '2015-04-12 19:05:00', '2013-08-24 19:05:00', 'Le petit Grégory', '');
