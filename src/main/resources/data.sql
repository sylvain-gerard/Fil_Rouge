...
INSERT INTO `fil_rouge`.`affaire` (`classee`, `date_cloture`, `date_creation`, `nom_affaire`, `pieces_conviction`) VALUES (True, '2013-08-30 19:05:00', '2013-08-30 19:05:00', 'La Brouette disparue', 'Trace de pas, trace de roue.');
INSERT INTO `fil_rouge`.`affaire` (`classee`, `date_cloture`, `date_creation`, `nom_affaire`) VALUES (False, '2013-08-30 19:05:00', '2013-08-30 19:05:00', 'Le petit Grégory');
INSERT INTO `fil_rouge`.`affaire` (`classee`, `date_cloture`, `date_creation`, `nom_affaire`, `pieces_conviction`) VALUES (True, '2013-08-30 19:05:00', '2013-08-30 19:05:00', 'La sucette abandonnée', '');

INSERT INTO `fil_rouge`.`suspect` (`id`, `nom`, `prenom`, `adn`, `adresse`, `date_naissance`, `infos_suspect`, `photo`, `poids`, `sexe`, `signes_particuliers`, `taille`) VALUES ('1', 'Manson', 'Charles', 'ACAAGATGCCATTGT', '2221 Hanover Street', '1934-11-12 19:05:00', 'Condamné à mort le 25 janvier 1971', 'https://fr.wikipedia.org/wiki/Charles_Manson#/media/File:CharlesManson2014.jpg', '70', 'M', 'Un des criminels les plus connus de l’histoire', '170');
INSERT INTO `fil_rouge`.`suspect` (`id`, `nom`, `prenom`, `adn`, `adresse`, `date_naissance`, `infos_suspect`, `photo`, `poids`, `sexe`, `signes_particuliers`, `taille`) VALUES ('2', 'Capone', 'Al', 'CTCCTGCTGCTGCTGCT', '378 Park Avenue', '1899-01-17 19:05:00', 'Un des plus grands gangsters du dernier siècle', 'https://fr.wikipedia.org/wiki/Al_Capone#/media/File:Al_Capone.jpg', '65', 'M', 'Surnommé « Scarface »', '159');
INSERT INTO `fil_rouge`.`suspect` (`id`, `nom`, `prenom`, `adn`, `adresse`, `date_naissance`, `infos_suspect`, `photo`, `poids`, `sexe`, `signes_particuliers`, `taille`) VALUES ('3', 'Parker', 'Bonnie', 'CAGTGCCGGGCCCCTCATA', '2154 Canis Heights Drive', '910-10-01 19:05:00', 'Spécialisée dans l\'attaque à main armée de banques.', 'https://anniversaire-celebrite.com/upload/250x333/bonnie-parker-250.jpg', '55', 'F', 'Femme, Brune.', '168');
